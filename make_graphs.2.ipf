...
macro plot_waves()
	...
	SavePICT/O/E=-5/B=72/win=graph0 as (s_filename[0,(strsearch(s_filename,".",0)-1)]+"spine")
	SavePICT/O/E=-5/B=72/win=graph1 as (s_filename[0,(strsearch(s_filename,".",0)-1)]+"trace.full")
	SavePICT/O/E=-5/B=72/win=graph2 as (s_filename[0,(strsearch(s_filename,".",0)-1)]+"max.response")
	SavePICT/O/E=-5/B=72/win=graph3 as (s_filename[0,(strsearch(s_filename,".",0)-1)]+"amplitude")

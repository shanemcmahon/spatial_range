...
wave Cx
if(!exists("wBeta"))
make /n=7 wBeta = {0.117,0.423,173,1,1,1.1e6,190,0,1}
...
if(!exists("wBeta"))
make /n=7 wBeta = {0.117,0.423,173,1,1,1.1e6,190,0}
SetDimLabel 0, 0, SigmaXY, wBeta; SetDimLabel 0, 1, SigmaZ, wBeta; SetDimLabel 0, 2, D, wBeta; SetDimLabel 0, 3, R, wBeta; SetDimLabel 0, 4, M, wBeta
SetDimLabel 0, 5, Kf, wBeta; SetDimLabel 0, 6, Kr, wBeta; SetDimLabel 0, 7, tt, wBeta
endif
...
///////////////////////////////////////////////////////////////////////////////
if(!exists("wBeta"))
make /n=7 wBeta = {0.117,0.423,173,1,1,1.1e6,190}
SetDimLabel 0, 0, SigmaXY, wBeta; SetDimLabel 0, 1, SigmaZ, wBeta; SetDimLabel 0, 2, D, wBeta; SetDimLabel 0, 3, R, wBeta; SetDimLabel 0, 4, M, wBeta
SetDimLabel 0, 5, Kf, wBeta; SetDimLabel 0, 6, Kr, wBeta
endif
...
make /o/n=(5e4) D3dGaussInit
setscale /p x,0,1e-6,"s",D3dGaussInit
setscale /i y,0,0,"M",D3dGaussInit
D3dGaussInit=(vM*exp(((-1)*(vR^2))/(4*vD*(x)+(2*(vSigmaXY^2)))))/(((2*pi)^1.5)*(2*vD*(x)+(vSigmaXY^2))*sqrt(2*vD*(x)+(vSigmaZ)^2))
end
...
//allow user interaction to edit parameters in table
//if the table was already open, assume user has already set desired values
dowindow /f Parameters
if(!v_flag)
edit /n=Parameters wBeta.l,wBeta
NewPanel/K=2 /n=PauseForUser0 as "Pause for user"; AutoPositionWindow/M=1/R=Parameters
...
if(!exists("wBeta"))
make /n=7 wBeta = {0.117,0.423,173,1e-3,1,1.1e6,190,0,1,0,2,20}
SetDimLabel 0, 0, SigmaXY, wBeta; SetDimLabel 0, 1, SigmaZ, wBeta; SetDimLabel 0, 2, D, wBeta; SetDimLabel 0, 3, R, wBeta; SetDimLabel 0, 4, M, wBeta
SetDimLabel 0, 5, Kf, wBeta; SetDimLabel 0, 6, Kr, wBeta; SetDimLabel 0, 7, tt, wBeta;SetDimLabel 0, 8, PeakGlu, wBeta
